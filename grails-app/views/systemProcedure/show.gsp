...
<html>
    ...
    <body>
        ...
        <div id="show-systemProcedure" class="content scaffold-show" role="main">
            ...
            <f:display bean="systemProcedure" />
            <g:form resource="${this.systemProcedure}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.systemProcedure}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
