...
<html>
    ...
    <body>
        ...
        <div id="show-systemDefaultMenu" class="content scaffold-show" role="main">
            ...
            <f:display bean="systemDefaultMenu" />
            <g:form resource="${this.systemDefaultMenu}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.systemDefaultMenu}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
