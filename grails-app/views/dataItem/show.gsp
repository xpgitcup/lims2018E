...
<html>
    ...
    <body>
        ...
        <div id="show-dataItem" class="content scaffold-show" role="main">
            ...
            <f:display bean="dataItem" />
            <g:form resource="${this.dataItem}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.dataItem}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
