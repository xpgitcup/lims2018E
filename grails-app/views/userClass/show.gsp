...
<html>
    ...
    <body>
        ...
        <div id="show-userClass" class="content scaffold-show" role="main">
            ...
            <f:display bean="userClass" />
            <g:form resource="${this.userClass}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.userClass}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
