...
<html>
    ...
    <body>
        ...
        <div id="show-systemTitle" class="content scaffold-show" role="main">
            ...
            <f:display bean="systemTitle" />
            <g:form resource="${this.systemTitle}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.systemTitle}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
